# Manual Guía para la Gobernanza de Activos Digitales en PYMES v_1

## 1. Introducción
Este manual guía tiene como propósito fortalecer la gobernanza de activos digitales en pequeñas y medianas empresas, reconociendo que cada herramienta tecnológica no solo cumple una función operativa, sino que encierra decisiones estratégicas, vínculos humanos y memorias organizacionales. Está diseñado para acompañar procesos de transformación digital con propósito, cuidado y sostenibilidad.
...
En el nivel proyecto, aplicar la función de control sobre el dominio de riesgo puede implicar definir protocolos de respaldo para una base de datos.
